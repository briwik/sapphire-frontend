...
const NextDrawCard = () => {
  ...
  const { endTime, amountCollectedInCandy, userTickets, status } = currentRound
  ...
  const prizeInBusd = amountCollectedInCandy.times(cakePriceBusd)
      ...
      <>
        ...
        {prizeInBusd.isNaN() ? (
          ...
          <Balance
            ...
            textAlign={['center', null, null, 'left']}
            unit=" CANDY"
            value={getBalanceNumber(amountCollectedInCandy)}
            decimals={0}
          />
        )}
      </>
