...
export const parseRetrievedNumber = (number: string): string => {
  const numberAsArray = number ? number.split('') : [1, 0, 0, 0, 0, 0, 0]
...
export const processLotteryResponse = (
  ...
  const priceTicketInCandy = new BigNumber(priceTicketInCandyAsString)
  const amountCollectedInCandy = new BigNumber(amountCollectedInCandyAsString)
